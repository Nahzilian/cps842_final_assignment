       ...
       # removing / at the end to make sure local urls are valid upon concat
        ...
        for link in links:
            ...
            if fetched_url is not None and fetched_url != '':
                if fetched_url[0] not in ['#', '/'] and fetched_url[-3:] not in ['pdf', 'jpg', 'png'] and fetched_url not in traversed and "instagram.com" not in fetched_url and "facebook.com" not in fetched_url and "linkedin.com" not in fetched_url and "twitter.com" not in fetched_url:
